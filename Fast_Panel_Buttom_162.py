...
class BUTTOM_OT_BevelWeight1(Operator):
    ...
    ### Crease ### OPERATORS ###
class BUTTOM_OT_Crease0(Operator):
    ### buttom left = Crease 0 ###
    bl_idname = "buttom.crease_0"
...
class BUTTOM_OT_Crease1(Operator):
    ### buttom right = Crease 1 ###
    bl_idname = "buttom.crease_1"
...
class BUTTOM_OT_SpeedOperationBevelSubserfEdit(Operator):
...
class BUTTOM_OT_SpeedOperationBevelSubserfObject(Operator):
    bl_idname = "buttom.speed_operation_bev_sub_object"
    bl_label = "Bevel and Subsurf"
...
class BAR_PT_Panel(Panel):
    ...
    ### Buttom visibility in edit mode ###
        if context.object is not None and context.mode == 'EDIT_MESH':
            ...
            op = spl.operator("buttom.crease_0", text="c0.00")
            op = spl.operator("buttom.crease_1", text="c1.00")
            layout.label(text="Speed Edge Bevel Weight:")
            col = layout.column()
            #box = layout.box()
            spl = col.split(align = True)
            #buttom left
            op = spl.operator("buttom.bevel_weight_0", text="w0.00")
            #buttom right
            op = spl.operator("buttom.bevel_weight_1", text="w1.00")
            col = layout.column()
    ...
    ### Buttom visibility in edit mode ### Bevel Subdivision ###
        ...
        if context.object is not None and context.mode == 'OBJECT':
            layout.label(text="Set Mesh Bevel and Subserf:")
            col = layout.column()
            op = col.operator("buttom.speed_operation_bev_sub_object")
...
CLASSES = [
    ...
    BUTTOM_OT_SpeedOperationBevelSubserfEdit,
    BUTTOM_OT_SpeedOperationBevelSubserfObject,
    BAR_PT_Panel,
    EditCategoryAddonUI,
]
